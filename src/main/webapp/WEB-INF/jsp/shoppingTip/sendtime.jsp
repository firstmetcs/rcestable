...
<body>
    ...
    <div class="purchase-wrapper" style="height: 500px;">
        <br>
    ...
    <div class="purchase-nav">
        ...
        <span>&nbsp;/&nbsp;</span>
        <a href="sendtime.jsp" title="忘记密码"><span>发货时效</span></a>
    </div>
    <div class="purchase-leftsidebar">
        <table class="purchase-leftsidebar-toptable">
            <tbody>
                ...
                <tr>
                    <td><a href="sendtime.jsp" title="发货时效"><span class="purchase-key">发货时效</span></a></td>
                </tr>
                <tr>
     ...
     <div class="purchase-sendtime-div-right">
        <div class="purchase-font-right-top">
            <h1>发货时效</h1>
        </div>
        <div class="purchase-font-right-bottom">
            <p>亲爱的R粉，RCE网将参照支付顺序在7天内发出，F码购买的商品，无法保证均可在7天内发出（活动期间以活动公告为准），最快情况下我们的商品会在24小时内出库的，受客观物流因素影响，可能会有部分延迟，请您耐心等待。
             <br>注：快递配送可能会因为交通、天气等原因有所延误，建议您登陆RCE官网,
                以您实际支付150元为基准包邮，特殊商品如体重秤、大家电等单独收取快递费用。
            </p>
        </div>
    </div></div>
    </div>
