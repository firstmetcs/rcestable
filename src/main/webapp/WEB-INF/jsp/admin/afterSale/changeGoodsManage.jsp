...
<table>
    ...
    <c:forEach items="${goodsChangeList}" var="goodsChange" varStatus="s">
        <tr>
            <td>${goodsChange.get("goodsChange").goodsChangeId}</td>
            <td>${goodsChange.get("goodsChange").orderId}</td>
            <td>${goodsChange.get("goodsChange").userId}</td>
            <td>${goodsChange.get("goodsChange").goodsAttrId}</td>
            <td class="status" id="${s}">${goodsChange.get("status")}</td>
            <td>
