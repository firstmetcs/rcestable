(function (window, document) {
    var SliderBar = function (targetDom, options) {
        ...
        if (dataList.length > 0) {
            var html = "<div class='slide-box'><div class='slide-img-block' id='slide-img-block'>" +
                "<div class='slide-loading'></div><div class='slide-img-border'><div class='slide-img-border-wrap'>"+ 
                ...
                "<div class='slide-bottom-no-logo'></div></div></div></div></div>" +
    ...
    SliderBar.prototype = {
        ...
        event: function () {
            var _this = this;
            _this.reToNewImg();
            _this.slideBtn.onmouseover = function(event){
                _this.mouseover(_this, event);
            } 
        ...
        reToNewImg: function () {
            ...
            _this.slideImg.onload = function (e) {
                ...
                _this.imgWidth = 260;                   // 图片宽
                _this.imgHeight = 116;                 // 图片高
            }
        },
        //裁剪图片
        cutImg: function () {
        ...
        mouseover: function(_this, e) {
            e.preventDefault();
            document.getElementById("slide-img-block").style.display = "block";
            document.addEventListener('mouseout', mouseout);
            // 鼠标离开
            function mouseout(event) {
               document.getElementById("slide-img-block").style.display = "none";
            };
        },
        mousedown: function (_this, e) {
            ...
            function mouseup() {
                ...
                if(_this.resultX > (left - 10) && _this.resultX < (left + 10)){
                    _this.isSuccess = true;
                    ...
                    // 设置样式
                    // 裁剪图片(拼图的一块)
                    _this.slideBlock.style.left = "10px";
                    _this.slideBlock.style.transition = "left 2.0s";
                    // 错误弹出的图标
                ...
                _this.slideBtn.style.transition = "left 2.0s";
                _this.slideHint.style.opacity = "0.4";
            }
        }
    }
